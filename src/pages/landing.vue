  ...
  <div id="landing-page">
    <nav class="header-home">
      ...
      <section class="section">
        <button type="button" class="a-propos">a propos</button>
        <button type="button" class="nos-service">nos-service</button>
      ...
      <div class="rectangle">
        ...
        <div class="texts">
          ...
          <span class="description"
            >organiser votre emploi du temps rendu simple grace à cet outil de
            haute qualité et simple à utilisé</span
          >
