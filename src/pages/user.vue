<template>
  <div>
    <div class="text-center">
      <v-card height="900px">
        <v-tabs color="#b8b5ff" left icons-and-text>
          <v-tab><font-awesome-icon :icon="['fas', 'user']" /> </v-tab>
          <v-tab><v-icon>mdi-link</v-icon></v-tab>

          <v-tab-item class="account"> </v-tab-item>
