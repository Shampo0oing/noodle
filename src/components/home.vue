...
<div class="home-page">
  ...
  <div class="center">
    ...
    <div class="rectangle">
      <img src="https://i.imgur.com/pzggfry.png" alt="schedule">
      <div class="texts">
        <span class="title">L'éducation rendue simple.</span>
        <span class="description">organiser votre emploi du temps rendu simple grace à cet outil de haute qualité et simple à utilisé</span>
...
.center {
  ...
  .ellipse {
    ...
    background: linear-gradient(245.29deg, #EEA7EF 13.32%, #A690FC 28.55%, #FC96BB 50.5%, #FBD8DF 84.12%);
    filter: blur(182px);
  }
  .rectangle {
    z-index: 1;
    ...
    align-items: center;
    gap: 24px;
    background: linear-gradient(81.01deg, #FC96BB 2.55%, rgba(251, 216, 223, 0.31) 50.03%, #C492FE 97.52%);
    width: 1104px;
    height: 449px;
    border-radius: 37px;
    box-shadow: 0 4px 4px rgba(238, 167, 239, 0.22);
    img {
      margin-left: 40px;
      width: 412px;
    }
